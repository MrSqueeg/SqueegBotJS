...
module.exports = {
    ...
    async execute(interaction) {
        ...
        try {
            ...
            const query = searches[Math.floor(Math.random() * searches.length-1)];
            ...
            const results = await image.scrape(query, searchCount);
            console.log(results)
            var rand = Math.floor(Math.random() * searchCount-1);
            ...
            console.error('Error executing inspire command:', error);
            await interaction.editReply({
